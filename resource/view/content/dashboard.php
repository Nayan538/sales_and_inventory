...
$categoriesResult = $eloquent->selectData($columnName, $tableName);
$totalCategories = count($categoriesResult);	
			...
			<div class="panel red-bg">
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-xs-8">
							<span class="state-title"> <b> Total Sale </b> </span>
			...
			<div class="panel blue-bg">
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-xs-8">
							<span class="state-title"> <b> Sales This Month  </b></span>
			...
			<div class="panel green-bg">
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-xs-8">
							<span class="state-title"><b> Total Categories  </b></span>
			...
			<div class="panel yellow-bg">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-xs-8">
							<span class="state-title"><b>  Total Products  </b></span>
			...
			<div class="panel blue-bg">
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-xs-8">
							<span class="state-title"><b>  Register Customer  </b></span>
