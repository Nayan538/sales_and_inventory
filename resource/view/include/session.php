...
#== TECHNICAL OPERATOR
$technicalOperatorPages = ['create-product.php', 'list-product.php', 'list-customer.php', 'invoice-list.php'];
...
#== CONTENT MANAGER
$contentManagerPages = ['create-category.php', 'list-category.php', 'create-subcategory.php', 'list-subcategory.php', 'list-customer.php', 'list-order.php', 'detail-order.php', 'invoice-list.php'];
...
#== SALES MANAGER
$salesManagerPages = ['create-product.php', 'list-product.php',  'create-category.php', 'list-category.php', 'create-subcategory.php', 'list-subcategory.php'];
